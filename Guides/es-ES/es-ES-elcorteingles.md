No pudimos confirmar una configuración TOTP estándar actual para El Corte Inglés. Usa esta guía solo si El Corte Inglés muestra un código QR o una clave manual para una app de autenticación; de lo contrario usa el método oficial del servicio.
