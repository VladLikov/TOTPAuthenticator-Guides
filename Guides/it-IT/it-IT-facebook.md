Facebook può usare diversi metodi di protezione dell’accesso: app di autenticazione, approvazione nell’app ufficiale, SMS, passkey o conferma dell’account. Aggiungi l’account a TOTP solo quando Facebook mostra un codice QR o una chiave manuale per un’app di autenticazione.
...
Inserisci in Facebook il codice a 6 cifre di TOTP.

### 7. Salva i codici di recupero

Se Facebook fornisce codici di recupero, conservali in modo sicuro. Se sono disponibili solo SMS, approvazione push, passkey o app ufficiale, usa quel metodo separatamente.
