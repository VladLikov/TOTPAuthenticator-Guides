Não foi possível confirmar uma configuração TOTP padrão atual para Millennium bcp. Use este guia apenas se Millennium bcp mostrar um código QR ou uma chave manual para app autenticador; caso contrário use o método oficial do serviço.
...
Digite em Millennium bcp o código de 6 dígitos mostrado pelo TOTP.
