Não foi possível confirmar uma configuração TOTP padrão atual para MB WAY. Use este guia apenas se MB WAY mostrar um código QR ou uma chave manual para app autenticador; caso contrário use o método oficial do serviço.
...
Digite em MB WAY o código de 6 dígitos mostrado pelo TOTP.
