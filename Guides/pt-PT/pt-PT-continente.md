Não foi possível confirmar uma configuração TOTP padrão atual para Continente. Use este guia apenas se Continente mostrar um código QR ou uma chave manual para app autenticador; caso contrário use o método oficial do serviço.
...
Digite em Continente o código de 6 dígitos mostrado pelo TOTP.
