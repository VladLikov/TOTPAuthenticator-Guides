As fontes públicas verificadas não confirmam uma configuração TOTP padrão com app autenticador para WhatsApp. O serviço pode proteger o login por SMS, e-mail, passkey, aprovação push, token físico ou app oficial. Adicione WhatsApp ao TOTP apenas se ele mostrar um código QR ou uma chave de configuração.

Fonte: https://www.whatsapp.com/faq/en/general/26000021
...
Digite em WhatsApp o código de 6 dígitos mostrado pelo TOTP.
