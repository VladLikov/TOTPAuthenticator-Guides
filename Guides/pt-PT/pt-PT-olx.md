Não foi possível confirmar uma configuração TOTP padrão atual para OLX. Use este guia apenas se OLX mostrar um código QR ou uma chave manual para app autenticador; caso contrário use o método oficial do serviço.
...
Digite em OLX o código de 6 dígitos mostrado pelo TOTP.
