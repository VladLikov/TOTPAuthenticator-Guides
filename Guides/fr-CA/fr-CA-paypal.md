PayPal peut utiliser différentes méthodes de protection de connexion : application d’authentification, approbation dans l’app officielle, SMS, passkeys ou confirmation du compte. Ajoutez le compte dans TOTP seulement si PayPal affiche un code QR ou une clé manuelle pour une application d’authentification.
...
Entrez le code à 6 chiffres de TOTP dans PayPal.

### 7. Enregistrez les codes de récupération

Si PayPal fournit des codes de récupération, gardez-les en lieu sûr. Si seuls les SMS, l’approbation push, les passkeys ou l’app officielle sont disponibles, utilisez cette méthode séparément.
