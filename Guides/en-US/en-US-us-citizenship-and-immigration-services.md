US Citizenship and Immigration Services supports setup with an authenticator app when the service shows a QR code or setup key. Use these steps for the authenticator-app option. SMS, passkeys, push approvals, hardware keys, and proprietary apps are configured separately.

Source: https://uscis.gov

### 1. Open US Citizenship and Immigration Services
...
Enter the 6-digit code from TOTP back in US Citizenship and Immigration Services.
