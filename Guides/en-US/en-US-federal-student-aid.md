Federal Student Aid supports setup with an authenticator app when the service shows a QR code or setup key. Use these steps for the authenticator-app option. SMS, passkeys, push approvals, hardware keys, and proprietary apps are configured separately.

Source: https://studentaid.gov/help-center/answers/topic/managing_your_account/article/choose-between-an-authenticator-app-text-email

### 1. Open Federal Student Aid
...
Enter the 6-digit code from TOTP back in Federal Student Aid.
