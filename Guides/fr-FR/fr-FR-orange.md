Nous n’avons pas pu confirmer de configuration publique de double authentification pour Orange. Vérifiez d’abord les paramètres de sécurité officiels. Ajoutez le service à TOTP uniquement si Orange propose une application d’authentification avec un code QR ou une clé.
...
Saisissez dans Orange le code à 6 chiffres affiché par TOTP.
