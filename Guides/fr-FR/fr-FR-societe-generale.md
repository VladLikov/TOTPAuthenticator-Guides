Société Générale peut utiliser différentes méthodes de protection de connexion : application d’authentification, approbation dans l’app officielle, SMS, passkeys ou confirmation du compte. Ajoutez le compte dans TOTP seulement si Société Générale affiche un code QR ou une clé manuelle pour une application d’authentification.

### 1. Ouvrez Société Générale
...
Entrez le code à 6 chiffres de TOTP dans Société Générale.

### 7. Enregistrez les codes de récupération

Si Société Générale fournit des codes de récupération, gardez-les en lieu sûr. Si seuls les SMS, l’approbation push, les passkeys ou l’app officielle sont disponibles, utilisez cette méthode séparément.
