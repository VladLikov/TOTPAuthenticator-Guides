Compte Microsoft peut utiliser différentes méthodes de protection de connexion : application d’authentification, approbation dans l’app officielle, SMS, passkeys ou confirmation du compte. Ajoutez le compte dans TOTP seulement si Compte Microsoft affiche un code QR ou une clé manuelle pour une application d’authentification.

### 1. Ouvrez Compte Microsoft
...
Entrez le code à 6 chiffres de TOTP dans Compte Microsoft.

### 7. Enregistrez les codes de récupération

Si Compte Microsoft fournit des codes de récupération, gardez-les en lieu sûr. Si seuls les SMS, l’approbation push, les passkeys ou l’app officielle sont disponibles, utilisez cette méthode séparément.
