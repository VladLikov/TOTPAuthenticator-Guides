GitHub permet une configuration avec une application d’authentification lorsque le service affiche un code QR ou une clé de configuration. Ces étapes concernent cette option. Les SMS, passkeys, validations push, clés matérielles et applications propriétaires se configurent séparément.

Source : https://docs.github.com/en/github/authenticating-to-github/securing-your-account-with-two-factor-authentication-2fa/configuring-two-factor-authentication
...
Saisissez dans GitHub le code à 6 chiffres affiché par TOTP.
