PayPal อาจใช้วิธีป้องกันการเข้าสู่ระบบหลายแบบ เช่น แอปยืนยันตัวตน การอนุมัติในแอปทางการ SMS passkey หรือการยืนยันบัญชี เพิ่มบัญชีลงใน TOTP เฉพาะเมื่อ PayPal แสดง QR code หรือคีย์แบบกรอกเองสำหรับแอปยืนยันตัวตนเท่านั้น
...
นำรหัส 6 หลักจาก TOTP ไปกรอกใน PayPal

### 7. เก็บ recovery codes

หาก PayPal มี recovery codes ให้เก็บไว้ในที่ปลอดภัย หากมีเฉพาะ SMS, push approval, passkey หรือแอปทางการ ให้ใช้วิธีนั้นแยกต่างหาก
