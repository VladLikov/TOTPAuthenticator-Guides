Las fuentes públicas revisadas no confirman una configuración TOTP estándar con app de autenticación para Steam. El servicio puede proteger el inicio de sesión con SMS, correo, passkey, aprobación push, token físico o su app oficial. Añade Steam a TOTP solo si muestra un código QR o una clave de configuración.

Fuente: https://help.steampowered.com/en/faqs/view/06B0-26E6-2CF8-254C
