No pudimos confirmar una configuración TOTP estándar actual para Clip. Usa esta guía solo si Clip muestra un código QR o una clave manual para una app de autenticación; de lo contrario usa el método oficial del servicio.
