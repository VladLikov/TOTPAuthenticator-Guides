Clip can use different sign-in protection methods: an authenticator app, approval in the official app, SMS, passkeys, or bank confirmation. Add the account to this app only when Clip shows a QR code or manual key for an authenticator app.
