Google permite configurarse con una app de autenticación cuando el servicio muestra un código QR o una clave de configuración. Estos pasos son para esa opción. SMS, passkeys, aprobaciones push, llaves físicas y apps propias se configuran por separado.

Fuente: https://safety.google/authentication/
