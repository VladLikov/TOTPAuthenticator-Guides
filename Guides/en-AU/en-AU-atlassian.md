Atlassian can use different sign-in protection methods: an authenticator app, approval in the official app, SMS, passkeys, or account confirmation. Add the account to TOTP only when Atlassian shows a QR code or manual key for an authenticator app.
...
If Atlassian offers recovery codes, keep them somewhere safe. If only SMS, push approval, passkeys, or an official app are available, use that method separately.
