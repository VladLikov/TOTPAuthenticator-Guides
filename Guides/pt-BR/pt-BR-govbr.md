Não foi possível confirmar uma configuração TOTP padrão atual para gov.br. Use este guia apenas se gov.br mostrar um código QR ou uma chave manual para app autenticador; caso contrário use o método oficial do serviço.
...
Digite em gov.br o código de 6 dígitos mostrado pelo TOTP.
