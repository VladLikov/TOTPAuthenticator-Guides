Não foi possível confirmar uma configuração TOTP padrão atual para Itaú. Use este guia apenas se Itaú mostrar um código QR ou uma chave manual para app autenticador; caso contrário use o método oficial do serviço.
...
Digite em Itaú o código de 6 dígitos mostrado pelo TOTP.
