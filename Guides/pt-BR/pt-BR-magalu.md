Não foi possível confirmar uma configuração TOTP padrão atual para Magalu. Use este guia apenas se Magalu mostrar um código QR ou uma chave manual para app autenticador; caso contrário use o método oficial do serviço.
...
Digite em Magalu o código de 6 dígitos mostrado pelo TOTP.
