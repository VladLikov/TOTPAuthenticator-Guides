Mercado Bitcoin permite configuração com app autenticador quando o serviço mostra um código QR ou uma chave de configuração. Estes passos são para essa opção. SMS, passkeys, aprovações push, chaves físicas e apps próprios são configurados separadamente.

Fonte: https://suporte.mercadobitcoin.com.br/hc/pt-br/articles/360039357491

### 1. Abra Mercado Bitcoin
...
Digite em Mercado Bitcoin o código de 6 dígitos mostrado pelo TOTP.
