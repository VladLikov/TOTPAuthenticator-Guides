Registro.br permite configuração com app autenticador quando o serviço mostra um código QR ou uma chave de configuração. Estes passos são para essa opção. SMS, passkeys, aprovações push, chaves físicas e apps próprios são configurados separadamente.

Fonte: https://registro.br/ajuda/gerenciamento-de-conta/token/
...
Digite em Registro.br o código de 6 dígitos mostrado pelo TOTP.
