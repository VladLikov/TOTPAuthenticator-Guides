Não foi possível confirmar uma configuração TOTP padrão atual para iFood. Use este guia apenas se iFood mostrar um código QR ou uma chave manual para app autenticador; caso contrário use o método oficial do serviço.
...
Digite em iFood o código de 6 dígitos mostrado pelo TOTP.
