Não foi possível confirmar uma configuração TOTP padrão atual para PicPay. Use este guia apenas se PicPay mostrar um código QR ou uma chave manual para app autenticador; caso contrário use o método oficial do serviço.
...
Digite em PicPay o código de 6 dígitos mostrado pelo TOTP.
