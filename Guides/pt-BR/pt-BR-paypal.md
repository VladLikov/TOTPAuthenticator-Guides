PayPal permite configuração com app autenticador quando o serviço mostra um código QR ou uma chave de configuração. Estes passos são para essa opção. SMS, passkeys, aprovações push, chaves físicas e apps próprios são configurados separadamente.
...
Digite em PayPal o código de 6 dígitos mostrado pelo TOTP.
