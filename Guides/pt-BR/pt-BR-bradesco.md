Não foi possível confirmar uma configuração TOTP padrão atual para Bradesco. Use este guia apenas se Bradesco mostrar um código QR ou uma chave manual para app autenticador; caso contrário use o método oficial do serviço.
...
Digite em Bradesco o código de 6 dígitos mostrado pelo TOTP.
