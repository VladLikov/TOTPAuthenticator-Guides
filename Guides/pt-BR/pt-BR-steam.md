As fontes públicas verificadas não confirmam uma configuração TOTP padrão com app autenticador para Steam. O serviço pode proteger o login por SMS, e-mail, passkey, aprovação push, token físico ou app oficial. Adicione Steam ao TOTP apenas se ele mostrar um código QR ou uma chave de configuração.

Fonte: https://help.steampowered.com/en/faqs/view/06B0-26E6-2CF8-254C
...
Digite em Steam o código de 6 dígitos mostrado pelo TOTP.
