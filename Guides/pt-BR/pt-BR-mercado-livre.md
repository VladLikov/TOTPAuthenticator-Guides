Mercado Livre permite configuração com app autenticador quando o serviço mostra um código QR ou uma chave de configuração. Estes passos são para essa opção. SMS, passkeys, aprovações push, chaves físicas e apps próprios são configurados separadamente.

Fonte: https://www.mercadolivre.com.br/ajuda/945
...
Digite em Mercado Livre o código de 6 dígitos mostrado pelo TOTP.
