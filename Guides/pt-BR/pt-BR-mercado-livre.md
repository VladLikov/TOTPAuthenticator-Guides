Mercado Livre pode usar diferentes métodos de proteção de acesso: aplicativo autenticador, confirmação no app oficial, SMS, passkey ou confirmação bancária. Adicione a conta neste app somente quando Mercado Livre mostrar um QR code ou uma chave de configuração para aplicativo autenticador.
