Binance supports setup with an authenticator app when the service shows a QR code or setup key. Use these steps for the authenticator-app option. SMS, passkeys, push approvals, hardware keys, and proprietary apps are configured separately.
