AJ Bell Youinvest supports setup with an authenticator app when the service shows a QR code or setup key. Use these steps for the authenticator-app option. SMS, passkeys, push approvals, hardware keys, and proprietary apps are configured separately.

Source: https://www.youinvest.co.uk/faq/how-do-i-set-two-factor-authentication

### 1. Open AJ Bell Youinvest
...
Enter the 6-digit code from TOTP back in AJ Bell Youinvest.
