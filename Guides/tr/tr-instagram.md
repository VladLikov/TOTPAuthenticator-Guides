Instagram farklı giriş koruma yöntemleri kullanabilir: kimlik doğrulama uygulaması, resmi uygulamada onay, SMS, passkey veya hesap onayı. Hesabı TOTP’ye yalnızca Instagram bir kimlik doğrulama uygulaması için QR kodu veya manuel anahtar gösterdiğinde ekleyin.
...
TOTP’deki 6 haneli kodu Instagram içine girin.

### 7. Kurtarma kodlarını saklayın

Instagram kurtarma kodları sunuyorsa güvenli bir yerde saklayın. Yalnızca SMS, push onayı, passkey veya resmi uygulama varsa bu yöntemi ayrı kullanın.
